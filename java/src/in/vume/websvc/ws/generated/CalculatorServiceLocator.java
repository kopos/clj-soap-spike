...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements in.vume.websvc.ws.generated.CalculatorService {
    ...
    public in.vume.websvc.ws.generated.Calculator getcalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            in.vume.websvc.ws.generated.CalculatorSoapBindingStub _stub = new in.vume.websvc.ws.generated.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (in.vume.websvc.ws.generated.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                in.vume.websvc.ws.generated.CalculatorSoapBindingStub _stub = new in.vume.websvc.ws.generated.CalculatorSoapBindingStub(new java.net.URL(calculator_address), this);
                _stub.setPortName(getcalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:in.vume.websvc", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:in.vume.websvc", "calculator"));
        }
